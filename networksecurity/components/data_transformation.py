...
class DataTransformation:
    ...
    def get_transformation_obj(cls)->Pipeline:
        logging.info('Entered get data transformer object of Data Transformation class')
        try:
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        logging.info('Entered data transformation method inside Data Transformation class')
        try:
            ...
            transformed_imput_train_feature=preprocessor_obj.transform(input_feature_train_df)
            transformed_imput_test_feature=preprocessor_obj.transform(input_feature_test_df)
            ...
            # Push preprocessor object to final model folder
